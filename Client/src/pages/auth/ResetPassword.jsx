...
const ResetPassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let hasError = false;
    const newErrors = { email: "", otp: "", newPassword: "", confirmPassword: "", general: "" };
    ...
    dispatch(resetPassword(userData))
      .then(() => {
        ...
        setUserData({ email: "", otp: "", newPassword: "", confirmPassword: "" });
        setErrors({ email: "", otp: "", newPassword: "", confirmPassword: "", general: "" });
      ...
      .catch((error) => {
        ...
        if (
          ...
          if (field && ["email", "otp", "newPassword", "confirmPassword", "general"].includes(field)) {
      ...
      <div className="bg-white p-6 sm:p-8 md:p-10 rounded-xl w-full max-w-md sm:max-w-lg lg:max-w-md border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            <Lock className="absolute left-3 top-11 -translate-y-1/2 size-5 text-gray-400 pointer-events-none" />
            <input
            ...
            <button
              ...
              className="cursor-pointer absolute right-3 top-11 -translate-y-1/2 flex items-center text-gray-500 hover:text-green-600 focus:outline-none"
            >
              {showNewPassword ? (
